...
type Producer interface {
	ProduceSyncEvent(ctx context.Context, tags BizTags) error
}
...
func NewSaramaSyncProducer(client sarama.SyncProducer) (Producer, error) {
	return &SaramaSyncProducer{client: client}, nil
}
