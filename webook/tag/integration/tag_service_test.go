...
import (
	...
	evtmocks "gindemo/webook/tag/events/mocks"
	"gindemo/webook/tag/integration/startup"
...
func (s *TagServiceTestSuite) TearPreload() {
...
func (s *TagServiceTestSuite) TestFullFlow() {
	...
	p.EXPECT().ProduceSyncEvent(gomock.Any(), gomock.Any()).AnyTimes().Return(nil)
