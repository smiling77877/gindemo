...
type FollowRelation struct {
	...
	// <followee, follower>
	// 我查询我关注了哪些人？ WHERE follower = 123(我的 uid)
...
const (
	FollowRelationsStatusUnknown uint8 = iota
	FollowRelationsStatusActive
	FollowRelationsStatusInactive
)
...
type FollowRelationDAO interface {
	...
	// UpdateStatus 更新状态
	UpdateStatus(ctx context.Context, follower, followee int64, status uint8) error
