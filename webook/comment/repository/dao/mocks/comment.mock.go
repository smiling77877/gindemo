...
import (
	context "context"
	dao "gindemo/webook/comment/repository/dao"
	reflect "reflect"
...
// FindCommitList mocks base method.
func (m *MockCommentDAO) FindCommitList(ctx context.Context, u dao.Comment) ([]dao.Comment, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindCommitList", ctx, u)
	ret0, _ := ret[0].([]dao.Comment)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// FindCommitList indicates an expected call of FindCommitList.
func (mr *MockCommentDAOMockRecorder) FindCommitList(ctx, u any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindCommitList", reflect.TypeOf((*MockCommentDAO)(nil).FindCommitList), ctx, u)
}
...
func (mr *MockCommentDAOMockRecorder) FindOneByIDs(ctx, ids any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
