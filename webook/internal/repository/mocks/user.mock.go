...
import (
	context "context"
	domain "gindemo/webook/internal/domain"
	reflect "reflect"
...
// UpdateNoneZeroFields mocks base method.
func (m *MockUserRepository) UpdateNoneZeroFields(ctx context.Context, user domain.User) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateNoneZeroFields", ctx, user)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateNoneZeroFields indicates an expected call of UpdateNoneZeroFields.
func (mr *MockUserRepositoryMockRecorder) UpdateNoneZeroFields(ctx, user any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateNoneZeroFields", reflect.TypeOf((*MockUserRepository)(nil).UpdateNoneZeroFields), ctx, user)
}
