...
func (d *DoubleWriteDAO) InsertLikeInfo(ctx context.Context, biz string, id, uid int64) error {
	panic("implement me")
}

func (d *DoubleWriteDAO) DeleteLikeInfo(ctx context.Context, biz string, id, uid int64) error {
	panic("implement me")
}
...
func (d *DoubleWriteDAO) GetLikeInfo(ctx context.Context, biz string, id, uid int64) (UserLikeBiz, error) {
	panic("implement me")
}

func (d *DoubleWriteDAO) GetCollectInfo(ctx context.Context, biz string, id, uid int64) (UserCollectionBiz, error) {
	panic("implement me")
}
