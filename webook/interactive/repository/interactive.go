...
import (
	"context"
	"gindemo/webook/interactive/domain"
...
type InteractiveRepository interface {
	...
	Collected(ctx context.Context, biz string, id, uid int64) (bool, error)
...
func (c *CachedInteractiveRepository) IncrLike(ctx context.Context, biz string, id, uid int64) error {
...
func (c *CachedInteractiveRepository) DecrLike(ctx context.Context, biz string, id, uid int64) error {
...
func (c *CachedInteractiveRepository) Liked(ctx context.Context, biz string, id, uid int64) (bool, error) {
...
func (c *CachedInteractiveRepository) Collected(ctx context.Context, biz string, id, uid int64) (bool, error) {
