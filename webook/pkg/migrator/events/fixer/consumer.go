...
import (
	...
	"gindemo/webook/pkg/migrator/fixer"
...
func NewConsumer[T migrator.Entity](client sarama.Client, l logger.LoggerV1, topic string,
	src, dst *gorm.DB) (*Consumer[T], error) {
