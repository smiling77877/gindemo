...
import (
	...
	"gindemo/webook/pkg/migrator/validator"
...
// 他不是必须的，你可以理解为这是为了方便用户操作（和你理解）而引入的。
...
func NewScheduler[T migrator.Entity](l logger.LoggerV1, src *gorm.DB, dst *gorm.DB,
...
// 这一个也不是必须的，就是你可以考虑利用配置中心监听配置中心的变化
