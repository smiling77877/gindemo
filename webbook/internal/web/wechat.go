...
import (
	...
	webookjwt "gindemo/webbook/internal/web/jwt"
...
func NewOAuth2WechatHandler(svc wechat.Service, hdl webookjwt.Handler, userSvc service.UserService) *OAuth2WechatHandler {
	return &OAuth2WechatHandler{
		svc:             svc,
		userSvc:         userSvc,
		key:             webookjwt.JWTKey,
