...
// Source: .\webbook\pkg\limiter\types.go
//
// Generated by this command:
//
//	mockgen -source .\webbook\pkg\limiter\types.go -package limitermocks -destination .\webbook\pkg\limiter\mocks\limiter.mock.go
//
